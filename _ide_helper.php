...
namespace {
    ...
    class Nginx extends \App\Facades\NginxFacade{
        ...
        public static function testConfiguration(){
            return \App\Utils\Nginx::testConfiguration();
        }
         ...
         * @static 
         */
        public static function rebootNginxInstance(){
            return \App\Utils\Nginx::rebootNginxInstance();
        }
         ...
         * @static 
         */
        public static function genNginxFile($proxy_dns, $server_ip, $has_ssl){
            return \App\Utils\Nginx::genNginxFile($proxy_dns, $server_ip, $has_ssl);
        }
         ...
         * @static 
         */
        public static function removeFile($proxy_dns){
            return \App\Utils\Nginx::removeFile($proxy_dns);
        }
         ...
         * @static 
         */
        public static function getFile($proxy_dns){
            return \App\Utils\Nginx::getFile($proxy_dns);
        }
         ...
         * @static 
         */
        public static function upSite($proxy_dns){
            return \App\Utils\Nginx::upSite($proxy_dns);
        }
         ...
         * @static 
         */
        public static function downSite($proxy_dns){
            return \App\Utils\Nginx::downSite($proxy_dns);
        }
         ...
         * @static 
         */
        public static function onMaintenance($proxy_dns){
            return \App\Utils\Nginx::onMaintenance($proxy_dns);
        }
         ...
         * @static 
         */
        public static function offMaintenance($proxy_dns){
            return \App\Utils\Nginx::offMaintenance($proxy_dns);
        }
         ...
         * @static 
         */
        public static function processFileData($file_content){
            return \App\Utils\Nginx::processFileData($file_content);
        }
         ...
         * @static 
         */
        public static function transformPattern($data){
            return \App\Utils\Nginx::transformPattern($data);
        }
         ...
         * @static 
         */
        public static function contains($param, $str){
            return \App\Utils\Nginx::contains($param, $str);
        }
        ...
        public static function toCharArray($str){
            return \App\Utils\Nginx::toCharArray($str);
        }
